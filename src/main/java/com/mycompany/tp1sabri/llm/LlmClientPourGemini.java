package com.mycompany.tp1sabri.llm; // A modifier...
...
public class LlmClientPourGemini implements Serializable {
    ...
    public LlmClientPourGemini() {
        this.key = System.getenv("GEMINI_KEY"); // A ECRIRE...
        ...
        this.target = clientRest.target("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + key); // A CHERCHER DANS LE COURS...
    }
